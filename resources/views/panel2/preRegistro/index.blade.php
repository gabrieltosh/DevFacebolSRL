        ...
        <div class="col-xs-12">                            
            <div class="box">
                <div class="box-header">
                    <h2 class="text-center">Pre Registros</h2>
                </div><!-- /.box-header -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                  <a class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-email-{{$preRegistro->id}}"><i class="fa fa-envelope-o"></i></a>                                  
                                  <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-show-{{$preRegistro->id}}"><i class="fa fa-eye"></i></a>
                                  <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete-{{$preRegistro->id}}"><i class="fa fa-trash-o"></i></a>
                                </td> 
                            </tr>
                            @include('panel.preRegistro.email')
                            @include('panel.preRegistro.delete')
                            @include('panel.preRegistro.show')
                            @endif
                            @endforeach                   
                        </tbody>
                        <tfoot>
...
<section class="content">
        <div class="col-xs-12">                            
            <div class="box">
                <div class="box-header">
                    <h2 class="text-center">Emails Enviados</h2>
                </div><!-- /.box-header -->
                <div class="col-xs-12 col-md-12" >
                    <div class="row">
                        <div class="col-xs-12 col-md-6" style="margin-bottom:15px">
