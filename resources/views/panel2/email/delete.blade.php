<div class="modal fade modal-slide-in-right" aria-hiddeen="true" role="dialog" tabindex="-1" id="modal-delete-{{$email->id}}">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="col-sm-12">
                        <p>¿Eliminar el registro <strong>{{$email->email}}</strong>?</p>
                    </div>    
                </div>
