<div class="modal fade modal-slide-in-right" aria-hiddeen="true" role="dialog" tabindex="-1" id="modal-delete-{{$ciudad->id}}">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="col-sm-12">
                        <p>¿Eliminar el registro <strong>{{$ciudad->nombre}}</strong>?</p>
                    </div>    
                </div>
