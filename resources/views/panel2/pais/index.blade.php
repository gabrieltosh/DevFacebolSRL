        ...
        <div class="col-xs-12">                            
            <div class="box">
                <div class="box-header">
                    <h2 class="text-center">Lista de Paises</h2>
                </div><!-- /.box-header -->
                    ...
                    <div class="row">
                                ...
                                <div class="col-xs-6 col-md-6" style="margin-right:0px; padding-right:0px;">
                                   ...
                                   <div class="col-sm-6 col-xs-6">
                                        <div class="col-md-3 col-xs-6">
                                                <div class="pull-right">
                                                    <a href="{{route('pais.index')}}" class="btn btn-info btn-sm"> <i class="fa fa-refresh" aria-hidden="true"></i></a> 
                                                </div>
                                        </div>
                                   </div>
                                    {{Form::close()}}
                        ...
                        <div class="col-xs-12 col-md-6 " style="margin-bottom:15px"> 
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-md-4">
                                    <div class="pull-right">
                                       <a href="{{route('pais.create')}}" type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Agregar</a>
                                    </div> 
                                </div>
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                  <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete-{{$pais->id}}"><i class="fa fa-trash-o"></i></a>                                   
                                  <a href="{{route('pais.edit',$pais->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                </td> 
                            </tr>                        
