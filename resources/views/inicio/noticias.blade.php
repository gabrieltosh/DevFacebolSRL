      ...
      <div class="ms-hero-page ms-hero-img-meeting ms-hero-bg-primary ms-bg-fixed mb-4">
        <div class="container">
          <div class="text-center">
            <h1 class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-5">{{$institucion->titulonoticias}}</h1>
            <p class="lead lead-lg color-light text-center center-block mt-2 mw-800 text-uppercase fw-300 animated fadeInUp animation-delay-7">{{$institucion->desnoticias}}</p>
          </div>
        </div>
      </div>
      <div class="container">
                  ...
                  <li class="ms-timeline-item wow materialUp">
                    ...
                    <div class="card card-info">
                      ...
                      <div class="card-body des">
                        <div class="row">
                           <div class="col-md-12">
                            <article>{!!$actividad->descripcion!!}</article>
                          </div>
