...
@section('contenido')
 {!!Form::model($usuario,['route'=>['usuarios.update',$usuario->id],'method'=>'PUT','id'=>'formulario','files'=>true])!!}
    <div class="card">
        <div class="card-header">
           <div class="row">
              ...
              <div class="pull-right">
                <div class="row">
                  <div class="col-sm-6">
                    <a href="{{route('usuarios.index')}}" class="btn btn-default"  style="margin-top: 5px;"><i class="zmdi zmdi-chevron-left"></i> Cancelar</a>
                  </div>
                  <div class="col-sm-6">
              ...
              <div class="row">
                               ...
                               <div class="col-sm-12 m-b-15">
                                  <p class="f-500 c-black m-b-15">Lider de equipo (codigo facebol)</p>
                                   @if($usuario->user_id!=null)
                                    {!!Form::select('user_id',$usuarios,null,['class'=>'chosen','data-placeholer'=>'Lider de Equipo','placeholder'=>$usuario->user_id])!!}
                                  @else
                                    {!!Form::select('user_id',$usuarios,null,['class'=>'chosen','data-placeholer'=>'Lider de Equipo','placeholder'=>'No tiene Equipo'])!!}
                                  @endif
                              </div>
                          </div>
                  ...
                  <div class="col-sm-4">
                      ...
                      <div class="fg-line">
                          ...
                          <img width="100px" height="100px" src="{{asset('imagen/usuarios/'.$usuario->imagen)}}" alt="">
                      </div>
                  </div>
                  </div>
              </div>
