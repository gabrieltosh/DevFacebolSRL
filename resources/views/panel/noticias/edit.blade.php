...
@section('contenido')
 {!!Form::model($actividad,['route'=>['noticias.update',$actividad->id],'method'=>'PUT','id'=>'formulario','files'=>true])!!}
    <div class="card">
        <div class="card-header">
           <div class="row">
              ...
              <div class="pull-right">
                <div class="row">
                  <div class="col-sm-6">
                    <a href="{{route('noticias.index')}}" class="btn btn-default"  style="margin-top: 5px;"><i class="zmdi zmdi-chevron-left"></i> Cancelar</a>
                  </div>
                  <div class="col-sm-6">
