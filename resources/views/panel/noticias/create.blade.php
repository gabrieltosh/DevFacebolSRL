...
@section('contenido')
 {!!Form::open(['route'=>'noticias.store','method'=>'POST','id'=>'formulario','files'=>true])!!}
    <div class="card">
              ...
              <div class="pull-right">
                <div class="row">
                  <div class="col-sm-6"  style="margin-top: 5px;">
                    <a href="{{route('noticias.index')}}" class="btn btn-default"><i class="zmdi zmdi-chevron-left"></i> Cancelar</a>
                  </div>
                  <div class="col-sm-6" style="margin-top: 5px;">
