            ...
            <section id="content">
                ...
                <div class="card">
                    <div class="action-header clearfix palette-Teal-400 bg">
                        <div class="ah-label hidden-xs palette-White text">Imagene de las Empresas</div>
                    </div>

                    <div class="card-body card-padding">
                        <div class="lightbox photos">
						@foreach($dir as $imagen)
                            <div data-src="{{asset('imagen/empresas/'.$imagen)}}" class="col-md-2 col-sm-4 col-xs-6">
                            	
                                <div class="lightbox-item p-item">
                                    <img src="{{asset('imagen/empresas/'.$imagen)}}" alt="" width="250px" height="120px" />
                                </div>
