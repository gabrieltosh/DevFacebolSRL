            ...
            <section id="content">
                ...
                <div class="card">
                    <div class="action-header clearfix palette-Teal-400 bg">
                        <div class="ah-label hidden-xs palette-White text">Imagenes de las Actividades y Noticias</div>
                    </div>

                    <div class="card-body card-padding">
                        <div class="lightbox photos">
						@foreach($dir as $imagen)
                            <div data-src="{{asset('imagen/actividades/'.$imagen)}}" class="col-md-2 col-sm-4 col-xs-6">
                            	
                                <div class="lightbox-item p-item">
                                    <img src="{{asset('imagen/actividades'.$imagen)}}" alt="" width="250px" height="120px" />
                                </div>
