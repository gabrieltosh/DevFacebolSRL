...
<div class="card">
    <div class="card-header">
        <div class="row">
        	<div class="col-sm-6">
        		<h2><strong>USUARIOS DE EMPRESAS REGISTRADAS</strong></h2>
        	</div>
        	<div class="col-sm-6">
	        ...
	        <tbody>
	            @foreach($usuarios as $usuario)
	                    <tr>
	                 	...
	                 	@include('panel.usuEmpre.show')
	                	@include('panel.usuEmpre.delete')
	                	@include('panel.usuEmpre.estado')
	            @endforeach       
	        </tbody>
	    </table>
	</div>
        ...
        formatters: {
            ...
            "commands": function(column, row) {
            	if(row.activo==1)
            	{
            		...
            		var edit="<a href=\"/panel/usuarios/empresa/"+row.id+"/edit\" class=\"btn btn-icon command-edit waves-effect waves-circle\"><span style=\"color: #00bcd4;\" class=\"zmdi zmdi-edit\"></span></a> " ;
