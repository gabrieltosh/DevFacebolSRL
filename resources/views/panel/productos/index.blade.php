...
<div class="card">
    <div class="card-header">
        <div class="row">
        	<div class="col-sm-6">
        		<h2><strong>PRODUCTOS REGISTRADOS</strong></h2>
        	</div>
        	<div class="col-sm-6">
        		<div class="pull-right">
        			<br>
        			<a href="{{route('productos.create')}}" class="btn btn-info"><i class="zmdi zmdi-plus"></i> Nuevo Registro</a>
        		</div>
        	</div>
        </div>
	        ...
	        <tbody>
	            @foreach($productos as $producto)
	                    <tr>
	                        ...
	                        <td class="text-center">{{$productos->imagen}}</td>
	                        <td class="text-center">{{$productos->activo}}</td>
	                        <td  class="text-center">
	                        </td>
	                    </tr>
                        @include('panel.productos.delete')
	            @endforeach
	        </tbody>
	    </table>
	</div>
  	...
  	$("#data-table-command").bootgrid({
        ...
        formatters: {
            ...
            "commands": function(column, row) {
            		...
            		var edit="<a href=\"/panel/productos/"+row.id+"/edit\" class=\"btn btn-icon command-edit waves-effect waves-circle\"><span style=\"color: #00bcd4;\" class=\"zmdi zmdi-edit\"></span></a> " ;
	          ...
	          "imagen": function(column,row){
	        	return "<img src=\"{{asset('imagen')}}/productos/" +row.imagen+"\" width=\"50px\" height=\"50px\" class=\"img-responsive img-thumbnail\" data-row-id=\"" + row.id + "\">";
            },
