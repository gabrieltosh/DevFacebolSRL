...
class controllerUsuario extends Controller
{
    ...
    public function index()
    {
        ...
        $ciudades=Ciudad::all();
        $usuarios=User::orderBy('id','desc')->where('tipo','Usuario')->get();
        Session::flash('message','Datos Cargados Correctamente');
        return view('panel.usuarios.index',compact('usuarios','categorias','ciudades','team'));
    }
    public function create()
    {
        ...
        return view('panel.usuarios.create',compact('ciudadess','usuarios','categorias','ciudades','team'));
    }
    ...
    public function edit($id)
    {
        ...
        $usuario=User::find($id);
        $usuarios=User::orderBy('id','desc')->pluck('cod_face','id');
        return view('panel.usuarios.edit',compact('usuario','ciudadess','usuarios','ciudades','categorias','team'));
    }
